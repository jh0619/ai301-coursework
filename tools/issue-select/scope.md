...
I am most comfortable with Python backend development, APIs, debugging, and unit testing. I also have experience with Java, React, and RAG-related projects. I prefer clearly scoped issues that can be completed and tested within a few hours, especially issues with identified files, reproducible failures, and existing tests.
